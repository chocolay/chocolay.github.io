        ...
        return function pcx(d, _opts) {
            ...
            while((Rn = xlmlregex.exec(str))) switch((Rn[3]=Rn[3].replace(/_.*$/,""))) {
                ...
                case 'table-row': case 'è¡Œ': // 9.1.3 <table:table-row>
                    ...
                    if(rowtag['è¡Œå·']) R = rowtag['è¡Œå·'] - 1; else ++R;
                    C = -1; break;
...
var fname = "/postapps/sunburst/data/customerevents.xlsx";
var selector = "#d3_app";
...
d3.request(fname)
    ...
    .response(function(req) {
        ...
        var events = d3.set(workbook[wb.SheetNames[0]].map(function (d) {
            return d.Event
        }))
            .values()
            .sort(d3.ascending)
        ...
        Z = d3.nest()
            ...
            .key(function (d, j) {
                return d["date"] + "_" + d["Event"]
            })
            .sortKeys(d3.ascending)
            .entries(workbook.sheet1);
