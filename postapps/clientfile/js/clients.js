...
d3.csv("clients.csv").then(function(data,error) {
        Z = data;
        ...
        d3.json("data/world.json").then(function(c,error) {
                ...
                const drawSphere = function(sphere,land,borders,countries_,features) {
                    ...
                    features
                        .forEach(f=>{
                            ...
                            context.lineWidth = d3.select(".projflip").datum()=="globe"?5:1;
                            context.stroke();
                        });
