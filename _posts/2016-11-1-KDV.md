...
You can play with this equation by adjusting the amplitude and width of an initial disturbance by sliding the orange bars. The shape quickly breaks up into solitons. They circle around so you can watch for a while and see them interact with each other.
